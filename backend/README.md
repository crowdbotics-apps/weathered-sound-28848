...
## Project Structure
    ...
    ├── weathered_sound_28848  # Django project configurations
...
1. Clone this repo and `cd weathered_sound_28848`
...
2. Clone this repo and `cd weathered_sound_28848`
